/**
 * Yerim Heo
 * A huge portion of this code is from the code in the Physical Computing lessons
 * and additional code provided by Liang He and Jon Froehlich
 */
...
void loop() {
  ...
  if (mode == 1) { // MODE 1: CROSSFADING RGB
    ...
    setColor(255, 0, 255, ledVal); // violet
  }
}

/**
 * set the color of the LED
 * parameters: values from 0 to 255 for red, green, blue, and brightness
 */
